...
// Temporary release unblock: allow login/app access even when email isn't verified.
// Set back to true once Firebase email action links are stable again.
...
// Emergency cost lock: disable Google Directions fallback and keep routing on TomTom.
export const GOOGLE_DIRECTIONS_API_ENABLED = true;
