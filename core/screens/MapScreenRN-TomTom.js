...
import { fetchRoute, getRouteStyle, shouldRenderOutline } from "@core/map/routingEngine";
...
const AMENITY_ICON_MAP = {
  ...
  const MANEUVER_ICON_MAP = {
    ...
    ROUNDABOUT_ENTER: { icon: "roundabout", label: "Enter roundabout" },
    ROUNDABOUT_EXIT: { icon: "roundabout", label: "Exit roundabout" },
    ROUNDABOUT_ENTER_LEFT: { icon: "roundabout", label: "Enter roundabout (left)" },
    ROUNDABOUT_EXIT_LEFT: { icon: "roundabout", label: "Exit left" },
    ROUNDABOUT_ENTER_RIGHT: { icon: "roundabout", label: "Enter roundabout (right)" },
    ROUNDABOUT_EXIT_RIGHT: { icon: "roundabout", label: "Exit right" },
    ROUNDABOUT_CROSS: { icon: "roundabout", label: "Continue straight" },
