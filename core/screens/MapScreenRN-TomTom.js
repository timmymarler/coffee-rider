...
const AMENITY_ICON_MAP = {
  ...
  const MANEUVER_ICON_MAP = {
    ...
    ROUNDABOUT_ENTER_LEFT: { icon: "roundabout-left", label: "Enter roundabout (left)" },
    ROUNDABOUT_EXIT_LEFT: { icon: "roundabout-left", label: "Exit left" },
    ROUNDABOUT_ENTER_RIGHT: { icon: "roundabout-right", label: "Enter roundabout (right)" },
    ROUNDABOUT_EXIT_RIGHT: { icon: "roundabout-right", label: "Exit right" },
