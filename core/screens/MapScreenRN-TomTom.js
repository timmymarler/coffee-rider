...
const AMENITY_ICON_MAP = {
  ...
  const MANEUVER_ICON_MAP = {
    ...
    ROUNDABOUT_EXIT: { icon: "arrow-up-bold", label: "Exit roundabout" },
    ROUNDABOUT_ENTER_LEFT: { icon: "rotate-left", label: "Enter roundabout (left)" },
    ROUNDABOUT_EXIT_LEFT: { icon: "arrow-left-bold", label: "Exit left" },
    ROUNDABOUT_ENTER_RIGHT: { icon: "rotate-right", label: "Enter roundabout (right)" },
    ROUNDABOUT_EXIT_RIGHT: { icon: "arrow-right-bold", label: "Exit right" },
    ROUNDABOUT_CROSS: { icon: "arrow-up-bold", label: "Continue straight" },
