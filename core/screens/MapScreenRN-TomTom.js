...
const ARRIVAL_RIGHT_META = { icon: "flag-checkered", label: "Destination on the right" };
  ...
  const MANEUVER_ICON_MAP = {
    ...
    ROUNDABOUT_EXIT_LEFT: { icon: "rotate-right", label: "Exit left" },
    ROUNDABOUT_ENTER_RIGHT: { icon: "rotate-right", label: "Enter roundabout (right)" },
    ROUNDABOUT_EXIT_RIGHT: { icon: "rotate-right", label: "Exit right" },
                ...
                return (
                  ...
                  >
                    <SvgPin
                      icon={c.icon}
                      size={32}
                      fill={active ? theme.colors.accentMid : '#635021'}
                      circle={active ? theme.colors.accentMid : '#635021'}
